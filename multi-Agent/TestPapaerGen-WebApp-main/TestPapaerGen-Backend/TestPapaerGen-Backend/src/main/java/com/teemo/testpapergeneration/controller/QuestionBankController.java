...
//            questionBank.setLabel_1(label_1);
    ...
    public String getEachChapterCount() {
        List<String> distinctLabel2FromQuestionBank = questionBankMapper.getDistinctLabel2FromQuestionBank();
        ArrayList<JSONObject> ret = new ArrayList<>();
        for (String eachLabel2 : distinctLabel2FromQuestionBank) {
            Integer count = questionBankMapper.getQuestionBankCountByLabel2(eachLabel2);
            JSONObject _tmp = new JSONObject();
            _tmp.put("label_1", eachLabel2);
