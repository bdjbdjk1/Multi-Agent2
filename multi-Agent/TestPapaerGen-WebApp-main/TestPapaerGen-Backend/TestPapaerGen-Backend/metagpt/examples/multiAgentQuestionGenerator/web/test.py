...
from examples.multiAgentQuestionGenerator.roles.QuestionReviewer import Reviewer
from examples.multiAgentQuestionGenerator.roles.CreatSummaryRole import CreateSummary
from examples.multiAgentQuestionGenerator.roles.CreateQuestionRole import CreateQuestion
...
def main(
    ...
    # 创建团队并雇佣智能体
    team = Team()
    team.hire([CreateSummary(), CreateQuestion(), Reviewer()])
