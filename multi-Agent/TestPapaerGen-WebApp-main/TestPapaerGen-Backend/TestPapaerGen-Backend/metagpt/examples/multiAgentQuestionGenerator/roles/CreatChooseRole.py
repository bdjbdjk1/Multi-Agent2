...
from examples.multiAgentQuestionGenerator.action.CreatChoose import Choose
...
class Teacher(Role):
    ...
    async def _act(self) -> Message:
        ...
        questions_text = await Choose().run(summary_content, difficulty_content, num_content, label_1_content,label_2_content,check)  # 调用生成题目的动作
