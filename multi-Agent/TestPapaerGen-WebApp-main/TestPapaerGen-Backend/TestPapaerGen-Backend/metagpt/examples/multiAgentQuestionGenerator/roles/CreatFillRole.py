...
from examples.multiAgentQuestionGenerator.action.CreatFill import Fill
...
class Teacher1(Role):
    name: str = "llm"
    profile: str = "Teacher1"

    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.set_actions([Fill])
    ...
    async def _act(self) -> Message:
        ...
        print("正在读取生成的科目摘要...............")
        questions_text = await Fill().run(summary_content, difficulty_content, num_content, label_1_content,
